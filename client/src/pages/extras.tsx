...
export default function Extras() {
  ...
  const extras: Extra[] = [
    ...
    },
    {
      ...
      price: 49,
      image:
        "https://images.unsplash.com/photo-1574285013029-29296a71930e?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80",
    ...
    },
    {
      ...
      price: 149,
      image:
        "https://images.unsplash.com/photo-1552550018-5253c1b171e1?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80",
      ...
      <section className="py-12 bg-slate-100">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            />
            <img
              src="https://firebasestorage.googleapis.com/v0/b/standardgates-222619.appspot.com/o/gallery%2F640%2F4.avif?alt=media"
              alt="Gallery preview"
              className="w-full h-60 object-cover rounded-lg"
            />
            <img
