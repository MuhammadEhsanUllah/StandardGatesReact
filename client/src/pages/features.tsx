          ...
          <Tabs defaultValue="security" className="w-full">
            ...
            <TabsContent value="security" className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <img
                    src="https://eliteindustries.co.uk/wp-content/uploads/2019/11/security-gates-1.jpg"
            ...
            <TabsContent value="smart" className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                  <img
                    src="https://eliteindustries.co.uk/wp-content/uploads/2019/11/security-gates-4.jpg"
            ...
            <TabsContent value="design" className="mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <img
                    src="https://www.diywarehouse.com.au/wp-content/uploads/2023/11/Steel-Crimp-Top-Security-Sliding-Gate.jpg"
