  ...
  const galleryItems: GalleryItem[] = [
    {
      ...
      category: "Driveway",
      description: "Elegant arched gate design with premium aluminum construction"
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1560749003-f4b1e17e2dfd?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80",
      category: "Driveway",
    ...
    <main>
      ...
      <section className="bg-primary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold font-heading mb-4">Inspiration Gallery</h1>
          <p className="text-white/90 text-lg max-w-3xl mx-auto mb-8">
            Browse our collection of custom gates and fences to inspire your next project
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="all" className="w-full">
            ...
            <TabsContent value="driveway">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {galleryItems.filter(item => item.category === 'Driveway').map(item => (
                  <GalleryCard key={item.id} item={item} onClick={() => openModal(item)} />
                ))}
              </div>
            </TabsContent>
            ...
            <TabsContent value="garden">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {galleryItems.filter(item => item.category === 'Garden').map(item => (
                  <GalleryCard key={item.id} item={item} onClick={() => openModal(item)} />
                ))}
              </div>
            </TabsContent>
            ...
            <TabsContent value="fence">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {galleryItems.filter(item => item.category === 'Fence').map(item => (
                  <GalleryCard key={item.id} item={item} onClick={() => openModal(item)} />
                ))}
              </div>
            </TabsContent>
            ...
            <TabsContent value="commercial">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {galleryItems.filter(item => item.category === 'Commercial').map(item => (
                  <GalleryCard key={item.id} item={item} onClick={() => openModal(item)} />
                ))}
              </div>
            </TabsContent>
      ...
      <section className="py-16 bg-slate-100">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="font-heading text-3xl font-bold text-slate-900 mb-4">Our Design Process</h2>
            <p className="text-slate-600">
              From initial concept to final installation, our streamlined process ensures a seamless experience
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-heading font-semibold text-lg mb-2">Consultation</h3>
                <p className="text-slate-600">
                  Discuss your requirements, preferences, and property specifications with our design experts.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-slate-600">
                  Our designers create custom gate or fence designs tailored to your specifications.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-heading font-semibold text-lg mb-2">Manufacturing</h3>
                <p className="text-slate-600">
                  Your design is precision-crafted in our American manufacturing facilities.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6 text-center">
                <div className="w-12 h-12 rounded-full bg-primary text-white font-bold flex items-center justify-center mx-auto mb-4">4</div>
                <h3 className="font-heading font-semibold text-lg mb-2">Installation</h3>
                <p className="text-slate-600">
                  We provide detailed DIY instructions or professional installation services.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                <h3 className="font-heading font-bold text-2xl text-slate-900">{selectedItem.title}</h3>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center">
                  <span className="font-medium text-slate-900 mr-2">Category:</span>
