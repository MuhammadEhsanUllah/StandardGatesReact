...
type CartAction =
  ...
  | { type: 'TOGGLE_UPGRADE'; payload: 'expediteManufacturing' | 'liftgateDelivery' }
  | { type: 'UPDATE_SHIPPING_INFO'; payload: Partial<CartState['shipping_info']> }
  ...
  switch (action.type) {
    ...
    case 'TOGGLE_UPGRADE':
      return {
        ...
        upgrades: {
          ...state.upgrades,
          [action.payload]: !state.upgrades[action.payload as keyof typeof state.upgrades],
        },
      };
...
interface CartContextType {
  ...
  toggleUpgrade: (upgrade: 'expediteManufacturing' | 'liftgateDelivery') => void;
...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  const toggleUpgrade = (upgrade: 'expediteManufacturing' | 'liftgateDelivery') => {
